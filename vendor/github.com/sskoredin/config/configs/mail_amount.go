...
func (c *MailAmount) Read() error {
	...
	c.Subject, err = client.Get(consul.AmountMailSubject)
	if err != nil {
		return err
	}
	c.Recipients, err = client.GetArray(consul.AmountMailRecipients)
	if err != nil {
		return err
	}
